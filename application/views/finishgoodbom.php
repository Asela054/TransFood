...
<div class="modal fade" id="bomDetailsEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form action="<?php echo base_url() ?>Finishgoodbom/Finishgoodbomlistedit" method="post"
					autocomplete="off">
	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <form action="<?php echo base_url() ?>Finishgoodbom/Finishgoodbominsertupdate" method="post" autocomplete="off">
                            <div class="form-row mb-1">
                                <div class="col">
                                    <label class="small font-weight-bold">Finish Good BOM Title*</label><br>
                                    <input type="text" class="form-control form-control-sm" name="bomtitle" id="bomtitle" required>
                                </div>
                            </div>
                            <div class="form-row mb-1">
                                <div class="col">
                                    <label class="small font-weight-bold">Finish Good*</label><br>
...
<!-- Modal -->
<div class="modal fade" id="viewBOM" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">View All BOM</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script>
    $(document).on("click", ".btnviewBOM", function () {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: '<?php echo base_url() ?>Finishgoodbom/ViewallBOMdetails',
            ...
            error: function (xhr, status, error) {
                console.log(error); // log any error messages to the console
            }
        });
    });
    ...
    $(document).ready(function() {
        ...
        $("#finishgood").select2({
            ...
            ajax: {
                url: "<?php echo base_url() ?>Finishgoodbom/Getfinishgoodlist",
                type: "post",
                dataType: 'json',
                delay: 250,
        ...
        $('#dataTable').DataTable({
            ...
            ajax: {
                url: "<?php echo base_url() ?>scripts/finishgoodbomlist.php",
        ...
        $('#dataTable tbody').on('click', '.btnEdit', async function() {
            ...
            if (r == true) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo base_url() ?>Finishgoodbom/Finishgoodbomedit',
                    success: function(result) { //alert(result);
                        var obj = JSON.parse(result);
                        $('#recordID').val(obj.id);
                        $('#bomtitle').val(obj.title);

                        $('#bominfodiv').html('');
                        $('#bominfodiv').html(obj.bominfo);
                        
                        var html1 = '';
                        html1 += '<option value="' + obj.finishgoodID + '">' + obj.productname + '-' + obj.productcode + '</option>';
