...
class PurchaseorderPrintinfo extends CI_Model{
    ...
    $sql =" SELECT `tbl_porder`.*, `tbl_supplier`.`suppliername`, `tbl_supplier`.`address` FROM `tbl_porder` 
    ...
    $unitPriceField = ($currencyType == 1) ? "unitprice" : "unitprice";
    $totalField = ($currencyType == 1) ? "total" : "total";
            ...
            <tr>
                <td style="vertical-align: top;">
                    <table style="width:100%;border-collapse: collapse;">
                        ...
                        <tr>
                            <td style="text-align: center;">'.$respond->row(0)->address.'</td>
                        </tr>
                    </table>
                </td>
                <td width="20%"></td>
