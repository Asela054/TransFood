...
$joinQuery = "FROM `tbl_material_info` AS `u` LEFT JOIN `tbl_material_suppliers` AS `ua` ON (`ua`.`idtbl_material_category` = `u`.`tbl_material_category_idtbl_material_category`) LEFT JOIN `tbl_material_category` AS `ua` ON (`ua`.`idtbl_material_category` = `u`.`tbl_material_category_idtbl_material_category`) LEFT JOIN `tbl_supplier` AS `ub` ON (`ub`.`idtbl_supplier` = `u`.`tbl_supplier_idtbl_supplier`) LEFT JOIN `tbl_unit` AS `uc` ON (`uc`.`idtbl_unit` = `u`.`tbl_unit_idtbl_unit`)";
