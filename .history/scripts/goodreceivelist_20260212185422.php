...
$columns = array(
	...
	array( 'db' => '`u`.`currency`', 'dt' => 'currency', 'field' => 'currency' ),
...
$extraWhere = "`u`.`status` IN (1,2) AND `u`.`grntype`='1' AND `u`.`tbl_company_idtbl_company`='$companyid' AND `u`.`tbl_company_branch_idtbl_company_branch`='$branchid'";
