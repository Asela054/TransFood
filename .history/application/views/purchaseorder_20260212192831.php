                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(full['confirmstatus']==1 && statuscheck==1){
                            ...
                            if(deletecheck==1){
                                button+='<button type="button" data-url="Ordertype/Ordertypestatus/'+full['idtbl_porder']+'/3" data-actiontype="3" class="btn btn-danger btn-sm text-light btntableaction"><i class="fas fa-trash-alt"></i></button>';
                        }
                        }
