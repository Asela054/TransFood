                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(full['confirmstatus']==1 && statuscheck==1){
                            ...
                            if(statuscheck==1){
                                button+='<button class="btn btn-warning btn-sm btnconfirm mr-1" id="'+full['idtbl_porder']+'/1" data-actiontype="1"'"><i class="fas fa-times"></i></button>';
                            }
                            if(editcheck==1){
                                button+='<button class="btn btn-primary btn-sm btnEdit mr-1" id="'+full['idtbl_porder']+'"><i class="fas fa-pen"></i></button>';
                            }
                            if(deletecheck==1){
                                button+='<button type="button" data-url="Ordertype/Ordertypestatus/'+full['idtbl_order_type']+'/3" data-actiontype="3" class="btn btn-danger btn-sm text-light btntableaction"><i class="fas fa-trash-alt"></i></button>';
                        }
                        }
