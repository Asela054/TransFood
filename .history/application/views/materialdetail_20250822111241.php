		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="form-group mt-3 text-right">
						<button type="button" class="btn btn-primary btn-sm" id="btncreatesupplier"><i class="fas fa-print mr-2"></i>ADD SUPPLIER</button>
						<input type="submit" class="d-none" id="hidesubmitbtn">
						<input type="reset" class="d-none" id="hideresetbtn">
						<input type="hidden" id="hidematerialid" value="">
					</div>
				</form>
			</div>
		</div>
