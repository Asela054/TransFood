...
<div class="modal fade" id="stockmodal" data-backdrop="static" data-keyboard="false" tabindex="-1"
	...
	<div class="modal-dialog modal-dialog-centered modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
            	<form action="<?php echo base_url() ?>Product/Stockupdate" method="post" autocomplete="off">
					<div class="form-group mb-1">
					...
					<div class="form-group mb-1">
						...
						<input type="hidden" name="hidestockproductid" id="hidestockproductid" value="">
...
<!-- Modal -->
<div class="modal fade" id="productprofilemodal" data-backdrop="static" data-keyboard="false" tabindex="-1"
	aria-labelledby="productprofileLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="productprofileLabel">&nbsp;</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<script>
	$(document).ready(function () {
			...
			"columns": [{
				...
				},
				{
					...
					"render": function (data, type, full) {
						...
						button+='<button class="btn btn-secondary btn-sm btnProductProfile mr-1" data-toggle="tooltip" data-placement="bottom" title="Product Profile" id="'+full['idtbl_product']+'"><i class="fas fa-box"></i></button>';
		...
		$('#productdataTable tbody').on('click', '.btnProductProfile', function () {
    var id = $(this).attr('id');

    $('#productprofilemodal').modal('show');

    $.ajax({
        url: "<?php echo base_url('Product/getProductProfileHTML'); ?>",
        type: "POST",
        data: { productid: id },
        success: function (data) {
            $('#productprofilemodal .modal-body').html(data);
        }
    });
});
