...
<script>
    ...
    $(document).ready(function() {
        ...
        // Store original total when page loads or when recalculated
        function storeOriginalTotal() {
        	originalTotal = parseFloat($("#hidetotalorder").val()) || 0;
        }
        ...
        $("#totaldiscount").on("input", function () {
        	...
        	// If USD conversion exists later
        	let usdRate = 300; // example rate
