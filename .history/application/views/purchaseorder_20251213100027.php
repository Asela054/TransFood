                        ...
                        <table class="table table-striped table-bordered table-sm small" id="tableorder">
                            <thead>
                                <tr>
                                    ...
                                    <th class="">Unit Price (LKR)</th>
                                    <th class="">Discount (LKR)</th>
                                    <th class="">Unit Price (USD)</th>
                                    <th class="">Discount (USD)</th>
                                    <th class="text-center">Unit Price</th>
                                    <th class="text-center">Discount</th>
                                    <th class="text-center">Unit Per Ctn</th>
                                    <th class="text-center">Ctn</th>
                                    <th class="text-center">Total Qty</th>
                                    <th class="">Total (LKR)</th>
                                    <th class="">Total (USD)</th>
    ...
    $(document).ready(function() {
        ...
        $("#formsubmit").click(function () {
            ...
            <tr class="pointer">
                ...
                <td class=" unitprice_lkr">${discount_lkr.toFixed(2)}</td>
                <td class=" unitprice_usd">${unitprice_usd.toFixed(2)}</td>
                <td class=" unitprice_usd">${discount_usd.toFixed(2)}</td>
