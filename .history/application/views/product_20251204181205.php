			...
			"columns": [{
				...
				},
				{
					...
					"render": function (data, type, full) {
						var button = '';
						button+='<button class="btn btn-warning btn-sm btnProductProf mr-1" data-toggle="tooltip" data-placement="bottom" title="Stock Add" id="'+full['idtbl_product']+'"><i class="fas fa-plus"></i></button>';
