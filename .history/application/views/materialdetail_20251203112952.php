        ...
        "columns": [{
        	...
        	},
        	{
        		...
        		"render": function (data, type, full) {
					...
					button+='<button class="btn btn-dark btn-sm btnSuppliers mr-1" data-toggle="tooltip" data-placement="bottom" title="Active" id="'+full['idtbl_material_info']+'"><i class="fas fa-users"></i></button>';
