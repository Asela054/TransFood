                        ...
                        <form id="createorderform" autocomplete="off">
                            ...
                            <div class="form-row mb-1">
								...
								<div class="col">
									...
									<select class="form-control form-control-sm" name="cuurencytype" id="cuurencytype" required>
										<option value="">Select</option>
										<?php foreach($currencytypelist->result() as $rowcurrencytypelist){ ?>
										<option value="<?php echo $rowcurrencytypelist->idtbl_order_type ?>"><?php echo $rowcurrencytypelist->type ?></option>
										<?php } ?>
									</select>
								</div>
                            </div>
