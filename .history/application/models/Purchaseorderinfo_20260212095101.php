...
class Purchaseorderinfo extends CI_Model{
    ...
    public function Purchaseorderinsertupdate(){
        ...
        $finalTotal = ($currencytype == 'USD' && !empty($totalusd)) ? $totalusd : $total;
        $finalDiscount = ($currencytype == 'USD') ? '0' : $totaldiscount;
        ...
        if($recordOption==1):
            ...
            foreach($tableData as $rowtabledata){
                ...
                $finalUnitPrice = ($currencytype == 2 && !empty($salepriceusd)) ? $salepriceusd : $unit;
                $finalDiscountAmount = ($currencytype == 2 && !empty($discountusd)) ? $discountusd : $discountlkr;
                $finalTotal = ($currencytype == 2 && !empty($totalusd)) ? $totalusd : $nettotal;
            ...
            if($respond->row(0)->confirmstatus>0):
                ...
                foreach($tableData as $rowtabledata){
                    ...
                    $finalUnitPrice = ($currencytype == 'USD' && !empty($salepriceusd)) ? $salepriceusd : $unit;
                    $finalDiscountAmount = ($currencytype == 'USD' && !empty($discountusd)) ? $discountusd : $discountlkr;
                    $finalTotal = ($currencytype == 'USD' && !empty($totalusd)) ? $totalusd : $nettotal;
