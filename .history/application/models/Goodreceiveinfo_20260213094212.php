...
class Goodreceiveinfo extends CI_Model{
    ...
    public function Goodreceiveconfirm($x, $y){
        ...
        if($confirmstatus==1):
            ...
            $this->db->select('tbl_grn.batchno, tbl_grn.currencytype, tbl_grn.batchno, tbl_grn.tbl_company_idtbl_company, tbl_grn.tbl_company_branch_idtbl_company_branch, tbl_grn.tbl_location_idtbl_location, tbl_grndetail.qty, tbl_grndetail.unitprice, tbl_grndetail.tbl_material_info_idtbl_material_info');
            $this->db->from('tbl_grn');
