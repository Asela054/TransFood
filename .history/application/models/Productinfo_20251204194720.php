...
public function ProductProfileModal()
{
    ...
    // ✅ PRODUCT DATA
    $sqlproduct = "SELECT `idtbl_product`, `prodcutname`, `productcode`, `productimg`, `desc`, `weight`, `retailprice`, `wholesaleprice`, `nopckperctn`, `mastercartoon`  , `nopckperctn`, `mastercartoon`
                   FROM `tbl_product`
    ...
    foreach ($bom as $row) {
        ...
        $sqlsup = "SELECT s.suppliername, ms.unitprice
                   ...
                   LIMIT 1"; // Only the latest supplier
