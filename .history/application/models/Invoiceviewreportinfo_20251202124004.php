						...
						<tr>
							<td colspan="2">
								<table width="100%" style="border-collapse: collapse;margin-top:10px;font-size:12px;">
									...
									<tfoot>
										<tr>
											<th colspan="6" style="text-align: left; color: #000;padding:5px; border-left: 1px solid #000; border-bottom: 1px solid #000;">TOTAL</th>
										...
										<tr>
											<th style="text-align: left; color: #000;padding:5px; border-left: 1px solid #000;">FREIGHT</th>
										...
										<tr>
											<td colspan="6" style="text-align: left; color: #000; padding: 5px; border-left: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000;"><b>GRAND TOTAL</b></td>
