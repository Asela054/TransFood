								...
								<table width="100%" style="border-collapse: collapse;margin-top:10px;font-size:14px;">
									<thead>
										<tr>
											...
											<th style="text-align: center; width:42%; border: thin 1px solid;" scope="col"> CODE</th>
											...
											<th style="text-align: center; width:10%; border: thin 1px solid;" scope="col">NO OF</th> PKS PER CARTON
