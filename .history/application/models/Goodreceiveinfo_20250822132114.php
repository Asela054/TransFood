...
class Goodreceiveinfo extends CI_Model{
    ...
    public function Goodreceivestatus($x, $y){
        ...
        if($type==1){
            ...
            $this->db->select('tbl_grn.batchno, tbl_grn.tbl_company_idtbl_company, tbl_grn.tbl_company_branch_idtbl_company_branch, tbl_grn.grntype, tbl_grn.tbl_location_idtbl_location, tbl_grn.tbl_supplier_idtbl_supplier, tbl_grn.grndate, tbl_grndetail.qty, tbl_grndetail.pieces, tbl_grndetail.total, tbl_grndetail.tbl_measurements_idtbl_mesurements, tbl_grndetail.unitprice, tbl_grndetail.tbl_print_material_info_idtbl_print_material_info, tbl_grndetail.tbl_machine_id, tbl_grndetail.tbl_sparepart_id, tbl_grn.tbl_print_porder_idtbl_print_porder');
			$this->db->from('tbl_grn');
			...
			if ($respond->num_rows() > 0) {
				foreach ($respond->result() as $row) {
					...
					$stockData = array(
						...
						'insertdatetime' => $updatedatetime,
						'tbl_user_idtbl_user' => $userID,
                        'tbl_material_info_idtbl_material_info' => $userID,
                        'tbl_location_idtbl_location' => $userID,
						'tbl_company_idtbl_company' => $companyid,
						'tbl_company_branch_idtbl_company_branch' => $branchid
					);
