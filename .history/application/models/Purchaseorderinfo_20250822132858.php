...
class Purchaseorderinfo extends CI_Model{
    ...
    public function Getunitpriceaccomaterial() {
        ...
        $sql = "SELECT `tbl_material_info`.`unitprice`, `tbl_material_info`.`unitperctn`, `tbl_unit`.`idtbl_unit`, `tbl_unit`.`unitname` FROM `tbl_material_suppliers` LEFT JOIN `tbl_unit` ON `tbl_unit`.`idtbl_unit`=`tbl_material_info`.`tbl_unit_idtbl_unit` WHERE `tbl_material_info`.`status` = ? AND `idtbl_material_info` = ?";
