			...
			<body>
				...
				<main>
					<table width="100%">
						...
						<tr>
							<td colspan="2"><h4 style="margin-top:5px;font-weight: normal;font-size: 14px;">REX - GSP NOTE: <span style="text-transform: capitalize;">'.$amountInWords.' only</span></h4></td>
						</tr>
					</table>
