...
public function ProductProfileModal()
{
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-4 border text-center p-2">
                <img src="{{product_image_url}}" class="img-fluid mb-1" alt="Product Image">
            </div>
            <div class="col-md-8">
                <h5 class="font-weight-bold">ITEM NAME: {{product_name}}</h5>
                <div>CODE: {{product_code}}</div>
            </div>
        </div>
        <hr>
    ';
    ...
    <table class="table table-bordered table-sm">
        ...
        <tbody>
            <tr>
                <td>{{material_name_1}}</td>
                <td>{{supplier_list_1}}</td>
                <td>{{qty_1}}</td>
                <td>{{price_list_1}}</td>
            </tr>
            <tr>
                <td>{{material_name_2}}</td>
                <td>{{supplier_list_2}}</td>
                <td>{{qty_2}}</td>
                <td>{{price_list_2}}</td>
            </tr>
            <tr>
                <td>{{material_name_3}}</td>
                <td>{{supplier_list_3}}</td>
                <td>{{qty_3}}</td>
                <td>{{price_list_3}}</td>
            </tr>
        </tbody>
    ...
    // ✅ ASSEMBLE ITEMS
    $html .= '
    <label class="badge badge-success mb-1">Assemble Items</label>
    <table class="table table-bordered table-sm">
        <thead class="bg-warning">
            <tr>
                <th>Item Name</th>
