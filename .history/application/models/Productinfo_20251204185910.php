...
public function ProductProfileModal()
{
    ...
    $sqlproduct = "SELECT idtbl_product, prodcutname, productcode, productimg, 
                    ...
                    FROM tbl_product 
                    WHERE status = 1
                    ORDER BY idtbl_product DESC";

    $products = $this->db->query($sqlproduct)->result();
    ...
    foreach ($products as $product) {
        ...
        $respondbom = $this->db->query($sqlbom, array($product->idtbl_product));
        ...
        <div class="border p-3 mb-4 rounded">
            ...
            <div class="row mb-2">
                <div class="col-md-4 text-center">
                    <img src="'.base_url().'uploads/'.$product->productimg.'" class="img-fluid mb-1">
                </div>
                <div class="col-md-8">
            ...
            <label class="badge badge-success mb-1">Raw Materials Chart</label>
        ...
        foreach ($respondbom->result() as $rowbom) {
            ...
            // ✅ GET LAST SUPPLIER PRICE FOR MATERIAL
            $sqlsup = "SELECT tbl_supplier.supname, tbl_material_suppliers.unitprice
                        ...
                        WHERE tbl_material_suppliers.status = 1
            ...
            $respondsup = $this->db->query($sqlsup, array($rowbom->idtbl_material_info))->row();

            $supplier = $respondsup ? $respondsup->supname : '-';
            $price = $respondsup ? number_format($respondsup->unitprice, 2) : '0.00';
        ...
        $html .= '
            ...
            <label class="badge badge-success mb-1">Assemble</label>
            <table class="table table-bordered table-sm">
                <thead class="bg-warning">
                    <tr>
                        <th>Material</th>
