...
class Invoiceviewreportinfo extends CI_Model{
    public function printreport($x){
        ...
        $sql = "SELECT `tbl_invoice_detail`.`idtbl_invoice_detail`, `tbl_invoice_detail`.`qty`, `tbl_invoice_detail`.`saleprice`, `tbl_invoice_detail`.`total`,`tbl_product`.`productcode`, `tbl_product`.`prod`, `tbl_product`.`weight`,`tbl_customer_porder_detail`.`unitprice`
