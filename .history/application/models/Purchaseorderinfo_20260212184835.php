...
public function Purchaseorderinsertupdate(){
    ...
    public function Purchaseorderview(){
            ...
            <div class="col-12">
                ...
                <table class="table table-striped table-bordered table-sm">
                    ...
                    foreach($responddetail->result() as $roworderinfo){
                        ...
                        $unitPrice = $roworderinfo->$unitPrice;
                        ...
                        $html .= '<tr>
                            ...
                            <td>'.$currencySign.number_format($roworderinfo->unitprice, 2).'</td>
                            <td class="text-right">'.$currencySign.number_format($roworderinfo->total, 2).'</td>
                        </tr>';
                    }
                    $html.='</tbody>
                </table>
        ...
        <div class="row mt-3">
            <div class="col-12 text-right"><h3 class="font-weight-bold">'.$currencySign.number_format($roworderinfo->netTotal, 2).'</h3></div>
        </div>
        ';
