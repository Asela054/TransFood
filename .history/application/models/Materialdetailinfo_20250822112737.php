    ...
    public function Materialdetailinsertupdate(){
        ...
        $updatedatetime=date('Y-m-d H:i:s');  
            ...
            $data = array(
                ...
                'updateuser'=> $userID, 
                'updatedatetime'=> $updatedatetime, 
                'tbl_material_info_idtbl_material_info'=> $materialcategory, 
                'tbl_supplier_idtbl_supplier'=> $unit
            );

            $this->db->where('idtbl_material_suppliers', $recordID);
            $this->db->update('tbl_material_suppliers', $data);
