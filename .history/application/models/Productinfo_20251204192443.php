...
public function ProductProfileModal()
{
    ...
    $sqlbom = "SELECT pb.qty, mi.materialname, mi.idtbl_material_info
    ...
    // ✅ MATERIALS TABLE WITH SUPPLIERS
    $html .= '
    ...
    $count = 1;
    foreach ($bom as $row) {
        // ✅ Get suppliers and previous cost for this material
        ...
        foreach ($suppliers as $sup) {
            ...
            $price_list .= number_format($sup->unitprice, 2) . '<br>';
        }
