            ...
            <tr>
                ...
                <td>
                    <table style="border-collapse: collapse; text-align: center; width: 100%;">
                        ...
                        <tr>
                            <td style="border-bottom: 1px dotted; border-left: none; border-right: none; border-top: none; height: 30px;"><img src="signature.png" alt="Signature" style="height: 50px; margin-top: 5px;"></td>
                        </tr>
                    </table>
                </td>
            </tr>
