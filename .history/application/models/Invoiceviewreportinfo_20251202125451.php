				...
				<main>
					<div class="invoice-container">
						...
						<table class="center-table" style="border-collapse: collapse; margin: 20px auto; width: 100%; font-size: 12px;">
							...
							<tfoot>
								<tr>
								<tdstyle="text-align: right; border: thin 1px solid; padding: 8px; font-weight: bold;" ></tdstyle=>
								<td></td>
									<td colspan="7" style="text-align: right; border: thin 1px solid; padding: 8px; font-weight: bold;">TOTAL</td>
									<td style="text-align: right; border: thin 1px solid; padding: 8px; font-weight: bold;">'.number_format($total, 2).'</td>
								</tr>
								<tr>
									<td colspan="9" style="text-align: right; border: thin 1px solid; padding: 8px; font-weight: bold;">FREIGHT</td>
									<td style="text-align: right; border: thin 1px solid; padding: 8px;">0.00</td>
								</tr>
								<tr>
									<td colspan="9" style="text-align: right; border: thin 1px solid; padding: 8px; font-weight: bold;">GRAND TOTAL</td>
