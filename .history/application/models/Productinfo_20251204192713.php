...
class Productinfo extends CI_Model{
    ...
    public function ProductProfileModal()
    {
        ...
        $sqlbom = "SELECT pb.qty, pb.wastage, mi.materialname, mi.materialinfocode, u.unitcode
                ...
                LEFT JOIN tbl_supplier sp ON ms.idtbl_supplier = ms.tbl_material_info_idtbl_material_info
