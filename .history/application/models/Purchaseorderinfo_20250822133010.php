...
class Purchaseorderinfo extends CI_Model{
    ...
    public function Getunitpriceaccomaterial() {
        ...
        $sql = "SELECT `tbl_material_info`.`unitprice`, `tbl_material_info`.`unitperctn`, `tbl_unit`.`idtbl_unit`, `tbl_unit`.`unitname` FROM `tbl_material_suppliers` LEFT JOIN `tbl_material_info` ON `tbl_material_info`.`idtbl_material_info`=`tbl_material_suppliers`.`tbl_material_info_idtbl_material_info` LEFT JOIN `tbl_unit` ON `tbl_unit`.`idtbl_unit`=`tbl_material_info`.`tbl_unit_idtbl_unit` WHERE `tbl_material_suppliers`.`status` = ? AND ``tbl_material_suppliers`.`.`idtbl_material_info` = ?";
